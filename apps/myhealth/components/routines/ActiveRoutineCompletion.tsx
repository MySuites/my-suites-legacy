...
export function ActiveRoutineCompletion({ onClearRoutine }: ActiveRoutineCompletionProps) {
  return (
    <View className="p-5 items-center">
      ...
      <TouchableOpacity onPress={onClearRoutine} className="p-2.5 rounded-lg border border-transparent dark:border-white/10 bg-light dark:bg-dark mt-4">
        <Text className="text-light dark:text-dark">Close Routine</Text>
      </TouchableOpacity>
    </View>
  );
}
